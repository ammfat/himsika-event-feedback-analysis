...
with DAG(
    ...
    create_view_fact_rates_by_responses = BigQueryOperator(
        task_id='create_view_fact_rates_by_responses'
    ...
    ] >> create_fact_rates_by_responses >> create_view_fact_rates_by_responses